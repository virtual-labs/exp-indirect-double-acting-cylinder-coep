...
//				+'<option value="1">Direct control of double acting cylinder</option>'
				+'<option value="2">Indirect control of double acting cylinder</option>'
				+'</select>'
				+'</div><br/>'
				+'</div>'
...
//				TODO If direct control of single acting cylinder selected
				if(selectedOp == 1 && component != null && actuator != null){
					if(component[0] == 3 && component[1] == 11 && component.length <= 2 && actuator == 1){
				...
				}else if(selectedOp == 2 && component != null && actuator != null){// TODO If indirect control of single acting cylinder selected

					if(component[0] == 3 && component[1] == 6 && component[2] == 11 && component.length <= 3 && actuator[0] == 1 && actuator[1] == 3 && actuator.length <= 2){
						alertify.alert("Component combination is correct. Please click on next level.");
						$("#wiringDiagram").show();
