...
function doubleActingCylinder(canvas,x1,y1){
	...
	var dacPort1 = doubleActCyl.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(04,98));
	dacPort1.setName("dacPort1Name");
	dacPort1.setId("dacPort1Id");
	
	var dacPort2 = doubleActCyl.createPort("hybrid", new draw2d.layout.locator.XYRelPortLocator(73, 98));
	dacPort2.setName("dacPort2Name");
	dacPort2.setId("dacPort2Id");
